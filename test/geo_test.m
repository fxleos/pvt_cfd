...
channel_type='P141';   %Channel type: 'P'-parallel, 'U', 'N'
draw_channel;
figure
subplot(2,1,1)
...
[u1,v1]=velocity_test([1,0],channel_flag,[1,1],[9,3] );
[u2,v2]=velocity_test([1,0],channel_flag,[10,3],[x_m-8,3] );
[u3,v3]=velocity_test([0,1],channel_flag,[9,4],[x_m-8,3] );
[u4,v4]=velocity_test([0,-1],channel_flag,[x_m-8,2],[x_m,1] );

u=u1+u2+u3+u4;
v=v1+v2+v3+v4;

mass_rate=(abs(u1+(u2+u3)/2+u4)+abs(v1+(v2+v3)/2+v4))*velo_amp*density_water*a_cross;
